...
<header id="header">
	<div id="head" class="parallax" parallax-speed="2">
		<h1 id="logo" class="text-center">
			...
			<span class="title">Hoho Jeong</span>
			<span class="tagline">A mystery person<br>
				<a href="http://jeong9041.cafe24.com/">jeong9041.cafe24.com</a></span>
		</h1>
	</div>
		...
		<div class="row section recentworks topspace">
			...
			<div class="thumbnails recentworks row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<a class="thumbnail" href="/sidebar-right">
						<span class="img">
		...
		<div class="row">
			<div class="col-md-3 widget">
				...
				<div class="widget-body">
					<p>+234 23 9873237<br>
						<a href="jeong9041.cafe24.com">jeong9041.cafe24.com</a><br>
						<br>
						218 Ayang Road, Donggu Daegu, TN 37015
					</p>	
				</div>
			</div>
